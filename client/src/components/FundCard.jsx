...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, amountWithdrawn, image, handleClick }) => {
    ...
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
      ...
      <div className="flex flex-col p-4">
        <div className="flex flex-row items-center mb-[18px]">
          ...
          <p className="ml-[12px] mt-[2px] font-epilogue font-medium text-[12px] text-[#808191]">Capstone</p>
        </div>
